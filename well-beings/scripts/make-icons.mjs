...
/* The dark-theme page ground from app/globals.css. The icon is always the
   night version: the blue sky and gold sun need the dark around them to
   read as light. */
const GROUND = "#1A0F0D";
...
/* The vector. Browsers use it for the tab when they prefer SVG, and an SVG
   ...
   favicon rendering: three bars, no door. That reads at 16px and still
   looks deliberate at 512. */
