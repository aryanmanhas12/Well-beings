...
export const STATEMENTS: Statement[] = [
  ...
  },
  {
    ...
    researchAgrees: false,
    reveal: {
      en: "The 21-day rule is a myth. When researchers actually tracked people daily, habits took between 18 and 254 days to feel automatic, with a median around two months. Plans built on three weeks set you up to quit at week four.",
  ...
  },
  {
    ...
    researchAgrees: false,
    reveal: {
      en: "It doesn't. Pooling 316 samples, researchers found four distinct recovery channels: switching off, relaxation, mastery and control. They don't substitute for each other. Doing nothing never delivers what learning something does.",
      hi: "नहीं देता। 316 नमूनों को जोड़कर शोधकर्ताओं ने आराम के चार अलग-अलग रास्ते पाए: मन हटाना, विश्राम, कुछ नया सीखना, और अपने समय पर नियंत्रण। ये एक-दूसरे की जगह नहीं ले सकते। कुछ न करना वह नहीं देता जो कुछ सीखना देता है।",
    },
  ...
  },
  {
    ...
    researchAgrees: false,
    reveal: {
      en: "Not close. Across 23 randomised trials, deep adaptation, meaning language plus genuinely local content, held dropout under 11%. Translation alone left it as high as 56%. It's the reason this page offers Hindi but won't machine-translate a validated screener.",
      hi: "बिल्कुल नहीं। 23 यादृच्छिक परीक्षणों में, गहरे अनुकूलन, यानी भाषा के साथ सचमुच स्थानीय सामग्री, ने छोड़ने की दर 11% से नीचे रखी। सिर्फ़ अनुवाद से यह 56% तक पहुँच गई। इसीलिए यह पन्ना हिन्दी में है, पर प्रमाणित स्क्रीनर का मशीनी अनुवाद नहीं करता।",
    },
