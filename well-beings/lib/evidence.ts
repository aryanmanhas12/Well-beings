...
export const EVIDENCE: EvidenceItem[] = [
  ...
  {
    tag: "Design",
    design: "Meta-analysis · 79 randomised trials · 92 app conditions",
    figure: "No points",
  ...
  {
    tag: "Design",
    design: "Longitudinal cohort · 2 trials · N=2,193",
    figure: "Seeing it",
  ...
  },
  {
    ...
    use: "the ten-second daily check-in, and honesty about what this app can and can't do without a human in the loop.",
    cite: "Torous et al., 2019, J. Affective Disorders",
    url: "https://consensus.app/papers/details/60e8d963c85d5748ae39860a810945b6/",
  },
  {
    tag: "Design",
    design: "Systematic review · 23 randomised trials · N=4,656",
    figure: "11% vs 56%",
