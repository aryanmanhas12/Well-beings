 ...
 *
 * `lit` (0 to 4) is the weekly rays on the Hope tab: the middle ray is
 * always lit, and each good thing kept this week lights one more.
 *
 * The frame colour follows the theme through --mark-frame: cream on the
 * night ground, near-black plum on dawn paper, as the logo canvas draws
 * its night and paper lockups.
 */
