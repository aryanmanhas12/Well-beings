  ...
  return (
    <div data-screen-label="Evidence library">
      ...
      <p style={{ color: "var(--color-neutral-500)", fontSize: 13, margin: "0 0 18px", maxWidth: 620, textWrap: "pretty" }}>
        Every recommendation in Arun traces to peer-reviewed research, mostly meta-analyses and large
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(310px,1fr))", gap: 14 }}>
        {EVIDENCE.map((ev) => (
          <div key={ev.cite} className="card" style={{ padding: 18, display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ fontSize: 12, color: "var(--color-neutral-500)" }}>In Arun: {ev.use}</div>
